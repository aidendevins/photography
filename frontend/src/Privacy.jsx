    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="prose prose-invert prose-lg max-w-none space-y-8 text-white/80">
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:hello@waypointjournals.com" className="text-amber-400 hover:text-amber-300 transition">
                hello@waypointjournals.com
              </a>
            </p>
          </section>
      ...
      <footer className="border-t border-white/10 mt-16">
        <div className="max-w-4xl mx-auto px-6 py-8 text-center text-white/40 text-sm">
          &copy; {new Date().getFullYear()} Waypoint Journals. All rights reserved.
        </div>
      </footer>
    </div>
  );
